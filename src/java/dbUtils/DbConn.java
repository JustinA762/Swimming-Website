...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "fa21_3308_tuo59359?user=tuo59359&password=eimeephu";
        ...
        try {
            ...
            try {
                ...
                recordError("Problem getting connection  - please try later or contact your administrator. Error:" + e.getMessage());
            }
        } catch (Exception e) { // cant get the driver...
            recordError("Problem getting driver - please try later or contact your administrator. Error:" + e.getMessage());
        }
    } // method

    private void recordError(String errorMsg) {
        this.errMsg = errorMsg;
        System.out.println("Problem with the DbConn - please try later or contact your administrator. Error: " + errorMsg);
    }
    ...
    private boolean isTemple() {
        ...
        try {
            ...
            recordError("Unable to get hostName - please try later or contact your administrator. Error: " + e.getMessage());
        }
        return temple;
    }
